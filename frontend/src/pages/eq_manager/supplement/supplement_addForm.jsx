...
export default function SupplementAddForm() {
  ...
  async function handleSubmit() {
    ...
    if (
      Sup_quantity === "" ||
      Number.isNaN(Number(Sup_quantity)) ||
      Number(Sup_quantity) <= 0
    ) {
    ...
    try {
      ...
      await axios.post(
        `${import.meta.env.VITE_BACKEND_URL}/api/supplement`,
        payload,
        { headers }
      );
      ...
      <div className="w-full max-w-4xl rounded-2xl border border-black/10 bg-white shadow-[0_10px_30px_rgba(0,0,0,0.05)] overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                >
                  <option className="block text-sm font-medium mb-1" value="">
                    Select a type...
                  </option>
                  {types.map((t) => (
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium mb-1">
                Inventory Manager<span className="text-red-600">*</span>
              </label>
              <div className="relative">
                <User
                  size={14}
